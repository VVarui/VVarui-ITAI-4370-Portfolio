...
Lab 5 I applied AI to a different kind of telecom problem: not predicting the network. Compressing a cloud-trained IoT classification model through pruning, quantization, and distillation showed me that AI deployment is about matching a model's footprint to the hardware it will run on. 
